...
var httpProxyAgent = _interopDefault(require('http-proxy-agent'));
...
function request (options) {
    ...
    var agent = null;
    if (global.translateProxyUrl) {
        var ProxyAgent = urlObj.protocol === 'https:' ? httpsProxyAgent : httpProxyAgent;
        agent = new ProxyAgent(global.translateProxyUrl);
    }
    var httpOptions = {
